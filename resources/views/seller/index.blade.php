...
<div class="row">
    <div class="col-12">
        <h4 class="page-title">Tableau des vendeurs</h4>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-body-head mb-3">
                    <!-- <h4 class="header-title">Tableau des vendeurs</h4> -->
                    <span></span>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btnSubmit").click(function() {
            window.location.href = "{{route('createSeller')}}"
        });
    });
    ...
    $('.update').on('click', function(e) {
        ...
        window.location.href = "/vendeur/update/" + id;
    });
